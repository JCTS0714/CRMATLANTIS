...
or are placed under a `docs/user` folder. Produces:
- storage/app/ai/docs-search/index_user.faiss
- storage/app/ai/docs-search/index_user_metadata.json

Usage: python scripts/docs/index_user_docs.py
"""
import json
