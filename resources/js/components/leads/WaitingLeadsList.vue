  ...
  <div class="space-y-4">
    <section class="rounded-2xl border border-slate-800 bg-slate-950 p-5 shadow-sm">
      <div class="flex flex-col gap-5 xl:flex-row xl:items-start xl:justify-between">
        <div class="space-y-3">
          <span class="inline-flex items-center rounded-full border border-amber-900/60 bg-amber-950/40 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-amber-200">
            Leads · En espera
          </span>
          <div>
            <h2 class="text-2xl font-semibold text-slate-50">Zona de espera operativa</h2>
            <p class="mt-2 max-w-3xl text-sm leading-6 text-slate-300">
              Revisa leads pausados, mantén observaciones al día y reactívalos cuando vuelvan a tener tracción comercial.
            </p>
          </div>
        </div>
        ...
        <div class="grid gap-3 sm:grid-cols-3 xl:min-w-[420px]">
          <div class="rounded-2xl border border-slate-800 bg-slate-900 p-4">
            ...
            <div class="mt-1 text-xs text-slate-400">En espera</div>
          </div>
      ...
      <div class="mt-5 grid gap-4 xl:grid-cols-[minmax(0,1fr)_auto] xl:items-end">
        <div class="w-full xl:max-w-xl">
          <label class="mb-2 block text-sm font-medium text-slate-200" for="waitinglead-search">Buscar lead</label>
          <div class="relative">
      ...
      <div ref="tableScrollRef" class="overflow-x-auto">
        <table ref="tableRef" class="min-w-full text-sm">
          ...
          <tbody class="divide-y divide-slate-800">
            <tr v-if="loading">
              <td class="px-4 py-8 text-center text-slate-300" :colspan="visibleKeys.length || columns.length">Cargando zona de espera…</td>
            </tr>

            <tr v-else-if="items.length === 0">
              <td class="px-4 py-12 text-center" :colspan="visibleKeys.length || columns.length">
                <div class="mx-auto max-w-md space-y-2">
                  <div class="text-base font-semibold text-slate-100">No hay leads en zona de espera</div>
                  <p class="text-sm leading-6 text-slate-300">Prueba otra búsqueda o importa una nueva base si necesitas volver a poblar esta lista.</p>
                </div>
              </td>
            </tr>
