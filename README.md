...
Estado y acciones en curso: [docs/planning/project-simplification-plan.md](docs/planning/project-simplification-plan.md)
...
# Validación rápida de calidad disponible hoy
composer quality
```

Notas:
- `composer run lint` existe, pero actualmente falla por deuda histórica de formato en backend; no usarlo como gate global hasta cerrar esa deuda.
